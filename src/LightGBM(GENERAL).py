...
CURRENT_MODEL = "LightGBM(GENERAL)";
...
if DO_GRIDSEARCH :
    ...
    gs_Estimator = LGBMRegressor(random_state=42, verbose = -1, n_jobs=-1);
...
params.pop("R2");
params = sanitize_params(LGBMRegressor, params=params)
params['random_state'] = 42

# feed the params to model, with random_state as 42
model = LGBMRegressor(**params, verbose = 2, n_jobs=-1);
