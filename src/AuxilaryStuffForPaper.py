...
# Load your models
# -------------------------
hist = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/HistGradientBoosting(GENERAL)/ModelFile/HistGradientBoosting(GENERAL).joblib")
gbr = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/GradientBoostingRegressor(GENERAL)/ModelFile/GradientBoostingRegressor(GENERAL).joblib")
xgbr = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/XGBOOST(GENERAL)/ModelFile/XGBOOST(GENERAL).joblib")
rf = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/RandomForestRegressor(GENERAL)/ModelFile/RandomForestRegressor(GENERAL).joblib")
svr = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/SVR(GENERAL)/ModelFile/SVR(GENERAL).joblib")
elastic = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/ElasticNet(GENERAL)/ModelFile/ElasticNet(GENERAL).joblib")
ridge = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/RidgeRegression(GENERAL)/ModelFile/RidgeRegression(GENERAL).joblib")
lasso = load("/home/arashp/Programming_Files/ML_Paper/TrainingResults/Models/Lasso(GENERAL)/ModelFile/Lasso(GENERAL).joblib")
